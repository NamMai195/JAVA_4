		...
		<div class="card border-warning">
			...
			<div class="card-body">
				<form action="yourServletURL" method="post">
					<div class="row mb-3">
						<div class="col-md-6">
							...
							<input type="text" class="form-control border-warning"
								id="username" name="username" value="TeoNV" required>
						</div>
						<div class="col-md-6">
							<label for="password"
					...
					<div class="row mb-3">
						<div class="col-md-6">
							<label for="fullname"
								class="form-label text-uppercase fw-bold text-secondary">Fullname?</label>
							<input type="text" class="form-control border-warning"
								id="fullname" name="fullname" value="Nguyễn Văn Tèo" required>
						</div>
						<div class="col-md-6">
							<label for="email"
								class="form-label text-uppercase fw-bold text-secondary">Email
								Address?</label> <input type="email" class="form-control border-warning"
								id="email" name="email" value="teonv@gmail.com" required>
						</div>
					</div>
				</form>
			</div>
			<div class="card-footer bg-light">
				<div class="d-flex justify-content-end">
					<button type="submit"
						class="btn btn-warning text-white fw-bold px-4">Update</button>
				</div>
			</div>
		</div>
	</div>
