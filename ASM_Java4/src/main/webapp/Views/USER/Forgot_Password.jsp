		...
		<div class="card border-warning">
			...
			<div class="card-body">
				<form action="yourServletURL" method="post">
					...
					<div class="mb-3">
						<label for="email"
							class="form-label text-uppercase fw-bold text-secondary">Email?</label>
						<input type="email" class="form-control border-warning" id="email"
							name="email" required>
					</div>
				</form>
			</div>
			<div class="card-footer bg-light">
				<div class="d-flex justify-content-end">
					<button type="submit"
						class="btn btn-warning text-white fw-bold px-4">Retrieve</button>
				</div>
			</div>
		</div>
	</div>
